...
[ExecuteInEditMode]
#endif
	[HelpURL("http://www.utopiaworx.com/Photoelectric/Vol1/Daydream.aspx")]
	[RequireComponent (typeof (UnityEngine.Camera))]
	[AddComponentMenu("Photoelectric Shaders/Daydream")]
	public class DayDream : PhotoelectricBase 
{
		...
		public static List<string> ZonePluginActivator()
		{
			...
			string Item1 = "Strength|System.Single|0.0|1.0|1|How strong is the mix";
			RetVal.Add(Item1);

			string Item2 = "Noise|System.Single|0.0|1.0|1|How much noise to add";
			RetVal.Add(Item2);
		...
		{
			return "Utopiaworx/Shaders/PostProcessing/Dream";
		}
		...
		protected override void OnRenderImage(RenderTexture source, RenderTexture destination)
		{
			...
			if(SourceMaterial == null || AlphaMask == null || LookupTexture == null)
			{
			...
			SourceMaterial.SetFloat("_Strength", Strength);
			SourceMaterial.SetFloat("_Noise", Noise);
			SourceMaterial.SetTexture("_AlphaBlend",AlphaMask);
